{ lib, buildPackages, natocamlPackages, writeScriptBin, osuper, stdenv }:

let
  isCross = stdenv.hostPlatform != stdenv.buildPlatform;
  natocaml = builtins.trace "natocaml is ${natocamlPackages.ocaml}" natocamlPackages.ocaml;
...
in if isCross then builtins.trace "HERE!" {
  name = "ocaml-cross";  
...
} else builtins.trace "OR HERE!" {
    name = "ocaml-host";
    configurePlatforms = []; # builtins.trace "configurePlatforms: ${lib.concatStringsSep ", " o.configurePlatforms}" o.configurePlatforms;
    configureFlags = builtins.trace "configureFlags: ${lib.concatStringsSep ", " o.configureFlags}" o.configureFlags;
})
